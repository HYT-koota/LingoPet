  ...
  return (
    <div className="h-full w-full overflow-y-auto app-main-scroll px-6 py-6 bg-brand-50/50 relative">
      ...
      <div className="bg-white/80 p-6 rounded-3xl border border-brand-50 mb-6">
        <h3 className="font-bold text-gray-800 mb-3">Growth Rules</h3>
        <ul className="text-sm text-gray-600 space-y-2 list-disc pl-4">
          <li><span className="font-bold">Daily learning:</span> Add new words (+10 XP).</li>
          <li><span className="font-bold">Daily review:</span> Complete review session (+50 XP).</li>
          <li><span className="font-bold">Evolution:</span> Pet evolves when XP reaches stage thresholds.</li>
          <li><span className="font-bold">Travel:</span> Teen/Adult pets can travel and send postcards.</li>
        </ul>
      </div>
        ...
        <div className="grid grid-cols-2 gap-2 gap-y-4">
          <div className="col-span-2 border-b border-gray-200 pb-2">
            ...
            <div className="flex justify-between">
              ...
              <span className={CURRENT_CONFIG.hasDirectTextKey ? 'text-green-600 font-bold' : 'text-gray-500 font-bold'}>
                {CURRENT_CONFIG.hasDirectTextKey ? 'Proxy + Local Fallback' : 'Proxy'}
              </span>
            </div>
            <div className="flex justify-between mt-1">
              <span className="opacity-70">Mode:</span>
              <span className="text-gray-700">{CURRENT_CONFIG.aiMode}</span>
            </div>
            <div className="flex justify-between mt-1">
          ...
          <div className="col-span-2">
            <span className="block font-bold text-gray-600 mb-1">Image API</span>
            <div className="flex justify-between">
              <span className="opacity-70">Status:</span>
              <span className={CURRENT_CONFIG.hasDirectImageKey ? 'text-green-600 font-bold' : 'text-gray-500 font-bold'}>
                {CURRENT_CONFIG.hasDirectImageKey ? 'Proxy + Local Fallback' : 'Proxy'}
              </span>
            </div>
            <div className="flex justify-between mt-1">
              <span className="opacity-70">Model:</span>
